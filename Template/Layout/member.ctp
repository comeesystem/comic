...
<header class="header">
            <a href="/" class="logo">
                <img src="<?=D_BASE_PATH?>assets/images/logo2.png" style="height:40px;" />
            </a>
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active">
                            <a href="<?=D_BASE_PATH?>members/">
                                <i class="fa  fa-bars"></i> <span>作品一覧</span>
                            </a>
                                <ul class="treeview-menu" style="display: block;">
                                    <?php foreach($comictitle as $key=>$val): ?>
                                        <li>
                                            <a href="<?=D_BASE_PATH?>members/edit/<?=$val[ 'id' ]?>" style="margin-left: 10px;">
                        ...
                        <li class="active">
                            <a href="<?=D_BASE_PATH?>members/create/">
                                <i class="fa fa-wrench"></i> <span>作品登録</span>
                            </a>
                        </li>
                        <li class="active">
                            <a href="<?=D_BASE_PATH?>members/profile/">
                                <i class="fa fa-user"></i> <span>プロフィール変更</span>
                            </a>
                        </li>
                        <li class="active">
                            <a href="<?=D_BASE_PATH?>members/logout/">
